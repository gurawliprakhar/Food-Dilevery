...
import { CREATE_CATEGORY_REQUEST, CREATE_EVENTS_FAILURE, CREATE_EVENTS_REQUEST, CREATE_EVENTS_SUCCESS, CREATE_RESTAURANT_FAILURE, CREATE_RESTAURANT_REQUEST, CREATE_RESTAURANT_SUCCESS, DELETE_EVENTS_FAILURE, DELETE_EVENTS_REQUEST, DELETE_EVENTS_SUCCESS, DELETE_RESTAURANT_REQUEST, DELETE_RESTAURANT_SUCCESS, GET_ALL_EVENTS_REQUEST, GET_ALL_EVENTS_SUCCESS, GET_RESTAURANT_BY_USER_ID_FAILURE, GET_RESTAURANT_BY_USER_ID_REQUEST, GET_RESTAURANT_CATEGORY_FAILURE, GET_RESTAURANT_CATEGORY_REQUEST, GET_RESTAURANT_CATEGORY_SUCCESS, GET_RESTAURANT_EVENTS_FAILURE, GET_RESTAURANT_EVENTS_SUCCESS, UPDATE_RESTAURANT_STATUS_FAILURE, UPDATE_RESTAURANT_STATUS_REQUEST, UPDATE_RESTAURANT_STATUS_SUCESS } from "./Reducer";
...
export const deleteAllEvents = ({ eventId, jwt}) => {
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("delete all events ", res.data)
...
export const createCategoryAction =({ reqData, jwt}) => {
    return async (dispatch)=>{
        ...
        try {
            ...
            dispatch({type: CREATE_CATEGORY_FAILURE, payload: res.data})
        } catch (error) {
            console.log("catch - ", error)
