...
export const GET_MENU_ITEM_BY_RESTAURANT_ID_FAILURE = 'GET_MENU_ITEM_BY_RESTAURANT_ID_SUCCESS';
...
export const UPDATE_MENU_ITEM_AVAILIBIILITY_REQUEST = 'UPDATE_MENU_ITEM_AVAILIBIILITY_REQUEST';
export const UPDATE_MENU_ITEM_AVAILIBIILITY_SUCCESS = 'UPDATE_MENU_ITEM_AVAILIBIILITY_SUCCESS';
export const UPDATE_MENU_ITEM_AVAILIBIILITY_FAILURE = 'UPDATE_MENU_ITEM_AVAILIBIILITY_FAILURE';